...
const TableWithTanStackQuery = <TData, TValue>({
  columns,
  data,
  totalDataNo,
  isDataFetching,
  ...
  }, [filterType, globalFilter, setSearchParams]);
  return (
    <Container className="pb-10">
      ...
      <section className="flex justify-between mb-5 items-center">
        <div className="flex space-x-4">
          ...
          <p>{isDataFetching && <p className="">Loading...</p>}</p>
        </div>
        <div className="flex">
          <input
...
export default TableWithTanStackQuery;
